# ðŸ“… Day_03: Aggregationsfunktionen (SUM, AVG, COUNT, MIN, MAX) & Gruppierung (GROUP BY, HAVING)
...
- [ ] VerstÃ¤ndnis des Hauptthemas: *Aggregationsfunktionen (SUM, AVG, COUNT, MIN, MAX) & Gruppierung (GROUP BY, HAVING)*
