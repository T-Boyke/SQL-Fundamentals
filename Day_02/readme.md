# ðŸ“… Day_02: Einfache SELECT-Abfragen, WHERE-Filterung & Sortierung (ORDER BY)
...
- [ ] VerstÃ¤ndnis des Hauptthemas: *Einfache SELECT-Abfragen, WHERE-Filterung & Sortierung (ORDER BY)*
